          ...
          <div class="testimonial-carousel owl-carousel owl-theme">
            ...
            <div class="testimonial-block">
              <div class="inner-box">
                ...
                <div class="text">Without JobHunt i’d be homeless, they found me a job and got me sorted out quickly with everything! Can’t quite… The Mitech team works really hard to ensure high level of quality</div>
                <div class="info-box">
                  <div class="thumb"><img src="{{ asset('assets/images/resource/testi-thumb-2.png') }}" alt=""></div>
            ...
            <div class="testimonial-block">
              <div class="inner-box">
                ...
                <div class="text">Without JobHunt i’d be homeless, they found me a job and got me sorted out quickly with everything! Can’t quite… The Mitech team works really hard to ensure high level of quality</div>
                <div class="info-box">
                  <div class="thumb"><img src="{{ asset('assets/images/resource/testi-thumb-3.png') }}" alt=""></div>
      ...
      <div class="auto-container">
        <div class="row">
          ...
          <div class="image-column col-lg-6 col-md-12 col-sm-12">
            ...
            <figure class="image wow fadeInLeft"><img src="{{ asset('assets/images/resource/mobile-app.png') }}" alt=""></figure>
          </div>
          ...
          <div class="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column wow fadeInRight">
              ...
              <div class="download-btn">
                <a href="#"><img src="{{ asset('assets/images/icons/apple.png') }}" alt=""></a>
                <a href="#"><img src="{{ asset('assets/images/icons/google.png') }}" alt=""></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="call-to-action">
      <div class="auto-container">
        <div class="outer-box wow fadeInUp">
          ...
          <div class="image-column" style="background-image: url(assets/images/resource/image-1.png);">
            <figure class="image"><img src="{{ asset('assets/images/resource/image-1.png') }}" alt=""></figure>
          </div>
        </div>
      </div>
    </section>
